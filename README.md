...
- Floor biomes now cycle between `catacomb` and `sewer`
- `sewer` adds flooded halls, grate/pool floor dressing, hidden gelatinous cubes, boosted rat archers, and poison traps
- Default `catacomb` biome preserves the original stone crypt layout and hazard set
